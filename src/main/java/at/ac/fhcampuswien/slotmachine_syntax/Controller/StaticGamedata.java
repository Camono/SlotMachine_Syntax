...
public class StaticGamedata {
    ...
    public static final Symbol U1 = new Symbol(null, SymbolType.U1, 0.20, 0.25,1.0, 2.5, false, false);
    public static final Symbol U6 = new Symbol(null, SymbolType.U6, 0.20, 0.25,1.0, 2.5, false, false);
    public static final Symbol REDBULL = new Symbol(null, SymbolType.RED_BULL, 0.16, 0.5,2.5, 7.5, false, false);
    public static final Symbol MARLBORO = new Symbol(null, SymbolType.MARLBORO, 0.15, 0.5,3.5, 10.0, false, false);
    public static final Symbol GIS = new Symbol(null, SymbolType.GIS, 0.12, 1.5,4.0, 15.3, false, false);
    public static final Symbol LUGNER = new Symbol(null, SymbolType.LUGNER, 0.07, 2.5,10.0, 50.0, false, false);
